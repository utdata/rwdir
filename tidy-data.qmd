...
We use janitor's [`round_half_up()`](https://sfirke.github.io/janitor/reference/round_half_up.html) function because the base R [`round()`](https://www.rdocumentation.org/packages/base/topics/Round) function rounds half values to the nearest even number, e.g. both 11.5 and 12.5 will be rounded to 12. In journalism, we would usually round up at 5 or higher, so 11.5 to 12 and 12.5 to 13.
:::
