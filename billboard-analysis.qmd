...
The difference between the who is how it handles `NA` values. If you `filter()` for specific values, it will not include NA values. If `filter_out()` for specific values, it will keep NAs.
