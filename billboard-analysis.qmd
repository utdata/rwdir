...
3.  Inside your code chunk, add this line of code:
...
2.  After the line that you added for the cleaning notebook, add another new line (with the same indenting) and put in the name of your analysis file. It should be `- 02-analysis.qmd`.
3.  Now re-Render your notebook and check the navigation on the page.
...
1.  Copy each of the examples below into your notebook, **but change the title and/or performer** to some that you like.
