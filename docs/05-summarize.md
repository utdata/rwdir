...
##  2 NAVARRO EA… '09-12            198      12.3       241      15.8          43
##  3 MCCALLUM H… '09-12            154       9.4       144       8.2         -10
##  4 NORTHEAST … '09-12            157      12.8       162      14.2           5
##  5 TRAVIS EAR… '09-12            199      15.2       200      17             1
##  6 CROCKETT E… '09-12            228      15.3       238      15.5          10
##  7 ANDERSON H… '09-12            146       6.6       190       8.6          44
...
##  4 SMALL MIDD… '06-08            108      10.8       163      13.3          55
...
##  6 MARTIN MID… '06-08            107      19.3       122      22.6          15
##  7 WILLIAMS EL 'EE-05             79      15.4        93      22.2          14
##  8 BEDICHEK M… '06-08            166      17.1       187      22            21
##  9 GOVALLE EL  'EE-05             57      10.5        79      21.7          22
## 10 CUNNINGHAM… 'EE-05             72      17.8        83      20.5          11
## # … with 4 more variables: sped_c_prccng <dbl>, sped_p_ppd <dbl>,
## #   sped15_thsh <chr>, sped20_thsh <chr>
```
...
##    school_name grade_range sped_c_15 sped_p_15 sped_c_20 sped_p_20 sped_c_diff
##    <chr>       <chr>           <dbl>     <dbl>     <dbl>     <dbl>       <dbl>
##  1 NORMAN-SIM… 'EE-06             34      11.4        12       9.5         -22
##  2 METZ EL     'EE-05             40      11.2        22      10.4         -18
##  3 SANCHEZ EL  'EE-05             38       8.8        21       7.8         -17
##  4 EASTSIDE M… '09-12            109      17.6        72      17.2         -37
##  5 BRYKER WOO… 'EE KG-06          22       5.6        16       4            -6
...
## 10 OAK SPRING… 'EE-05             39      12.7        33      14.4          -6
## # … with 99 more rows, and 4 more variables: sped_c_prccng <dbl>,
## #   sped_p_ppd <dbl>, sped15_thsh <chr>, sped20_thsh <chr>
```
...
##  9 WOOLDRIDGE… 'EE-05             34       6          79      14.6          45
