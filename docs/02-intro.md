...
<img src="images/02-rstudio-start.png" width="50%" />

When you launch RStudio, you'll get a screen that looks like this:

![Rstudio launch screen](images/02-rstudio-start.png){width=600px}
...
![Rstudio project name, directory](images/02-rstudio-newproject.png){width=400px}
...
![R code chunk](images/02-rstudio-rcodechunk.png){width=600px}
...
![Cars plot](images/02-rstudio-defaultplot.png){width=600px}
...
![R Notebook toolbar](images/02-rstudio-toolbar.png){width=600px}
...
![Files list](images/02-rstudio-files.png){width=500px}
...
```r
# ![Compress file: Mac](images/02-rstudio-compress.gif){width=400px}
```
