...
You can change just about *anything* on a ggplot chart if you know the function and arguments to describe it. The [cheetsheet](https://github.com/rstudio/cheatsheets/blob/main/data-visualization.pdf) shows a lot of them, but it can get really dense.
