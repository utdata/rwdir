...
If you are in Reporting with Data and use ChatGPT or other GenAI, then you are **required** to include in your notebook a description of what you were trying to do, the chat prompt that helped you get the answer, and comments or descriptions in your own words describing what each line of code does.
