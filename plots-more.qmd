...
- BEFORE printing that object, I save the plot with `ggsave()` with a path and name. Don't print out the object first or it will save at a weird size. Following R convention, I save plots into a folder called `figures/`.
