...
This version is being revised for **fall 2026**.
:::

Reporting with Data in R is a series of lessons and instructions used for courses in the School of Journalism and Media, Moody College of Communication at the University of Texas at Austin. This current version is authored by Associate Professor of Practice [Christian McDonald](https://moody.utexas.edu/faculty/christian-mcdonald), but there have been two past contributors I'm deeply indebted to: Professor [Josephine Lukito](https://www.jlukito.com/)  collaborated and taught sections of the Reporting with Data from 2022-2025 and [Anastasia Goodwin](https://anastasiagoodwin.com/) taught a section in fall 2023. They both have provided valuable edits to this work. Goodwin also wrote [Intro to Terminal and Git for R](https://utdata.github.io/git-for-r/), which my students and I use often.
...
-   Bluesky: [@crit.bsky.social](https://crit.bsky.social) \| Instagram: [@critmcdonald](https://www.instagram.com/critmcdonald) & Threads: [@critmcdonald](https://www.threads.net/@critmcdonald)
