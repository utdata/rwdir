...
Now that you have looked at this data, you should be able to describe what has happened to the share of special education students across the state. You'll do this in three parts: a written piece, a published chart, and you'll turn in this analysis.

### The written piece

You will write what would be the **first four paragraphs** of a followup story to the Denied series that is based on the facts you've found here. Keep the following in mind:

- The lede should be based on a finding from this analysis.
  - The statewide change in percentage and the number of districts that have climbed above the previous benchmark are the two main findings here. Pick one or the other for your lede, but then also cover the other later in a later paragraph. Don't worry about the local districts for this writing part.
- You need to source where the data came from, explain the time period, etc. You need to note our analysis was only traditional public schools and not charter or alternative education districts.
- You need to put this into context based on what was found in the Denied series, i.e. that the TEA had this benchmark for special education, they dropped it and the Legislature banned future benchmarks. You may source the Denied series.

See Canvas for submission instructions.

### A chart

Pick one of the charts you made in this analysis **and then make that chart in datawrapper**.

Some things to consider:
 
- You __might__ have to reshape your data to make the chart. Look first at [Datawrapper Academy](https://academy.datawrapper.de/) to see how to build the chart, and look at the data structure listed there.
- A reader should understand this chart without the reading the story. It needs a proper headline, description, axis names, source, a byline, etc.

See Canvas for submission instructions.

### The analysis

You'll turn in your R project like you have all your others, but take these things into account:

- Your R Notebook should be a written record of how you went about this analysis. Another R user should be able to open and read it and understand your goals and logic.
- Use beautiful R Markdown. Use proper headlines and text and lists, with proper spacing and such. **Knit your notebook and look at it**. Still not sure how to do this? Look at the top of the import notebook where I explained the data ... that is a good example.
- Make sure you compress the project _folder_, not just a file.

See Canvas for the submission assignment.
