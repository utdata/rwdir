...
We will install R and RStudio on your computer. It might take some time depending on your Internet connection. **If you are doing this on your own** you might follow [this tutorial](https://learnr-examples.shinyapps.io/ex-setup-r/), but below you'll find the basic steps.
...
Once you download the installation file, you should be able to run it on your respective computers to install R.

You'll never "launch" R as a program in a traditional sense, but you need it on your computers. The program we'll actually launch is RStudio, which we install next.
...
2.  **You've already done step 1** to install R. Go to Step 2!
3.  There should be a big blue button with **DOWNLOAD RSTUDIO DESKTOP** for you operating system. Click on that to download it.
4.  Install it.
