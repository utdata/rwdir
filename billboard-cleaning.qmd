...
::: callout-warning
Quarto updates are done. Rerunning will update data.
:::
...
If you look at the navigation or our website you'll notice that while we have our _Home_ page and our _About_ page (which we don't need) and we don't have a link to the Cleaning notebook we've been working so hard on! We need to update our `_quarto.yml` file to include it.
