...
2. We created a new object (or "bucket") called `hot100_date` and we fill it with our `hot100` data. Yes, as of now they are exactly the same.
3. I leave a blank line for clarity ...
4. Then another comment ...
5. Then we glimpse the new `hot100_date` object so we can see changes as we work on it.
