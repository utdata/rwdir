...
::: callout
We won't get into it here, but you can change your rendered page displays in many ways using  `quarto.yml` configurations. See the [Quarto Guide](https://quarto.org/docs/websites/) for more information.
:::
