...
- [`if_else()`](https://dplyr.tidyverse.org/reference/if_else.html), [`case_match()`](https://dplyr.tidyverse.org/reference/case_match.html) and [`case_when()`](https://dplyr.tidyverse.org/reference/case_when.html) are all functions that can be used with `mutate()` to create new categorizations with your data.
...
- [`count()`](https://dplyr.tidyverse.org/reference/count.html) is a shortcut for GSA that counts the number rows based on variable groups you feed it.
- [`tabyl()`](https://sfirke.github.io/janitor/articles/janitor.html#exploring) is another shortcut for GSA but it also calculates percentages.
