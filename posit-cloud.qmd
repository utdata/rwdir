...
If you can't or don't want to start with the template above, you can build your own Quarto Website.

### Create your project

1. Start posit.cloud if you haven't already
1. Use the **New Project** button and choose **New RStudio project**.
