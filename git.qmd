...
We'll use the `quarto publish` Terminal command to render and send files to our gh-pages branch in Github. This works just like when we have published to Posit Connect Cloud in other parts of this book, but we'll specify the destination as Github instead of Connect Cloud.
