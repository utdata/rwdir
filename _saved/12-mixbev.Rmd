...
- Use this mixed bev data as an all-in assignment with interviews.
- Offer the tidycensus practice of populations as a story idea
- Give a list of story ideas for them to work from, but have pairs choose different ideas
- Recover pivot_longer and pivot_wider and explain when you might use it.
